...
def send_email(mission_statement:str, html_code:str, email: str, idea_title:str, user_id:int, db: Session):
    try:
        ...
        emailObj.send_html_email(idea_title=idea_val.idea_title, email= email, token_link=f"http://localhost:8501/rating/{token_link}", mission_statement= mission_statement, feature_list= str(idea_val.features), html_code=html_code)
